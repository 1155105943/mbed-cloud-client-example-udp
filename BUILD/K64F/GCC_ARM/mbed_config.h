...
#define MBED_CONF_DATAFLASH_BINARY_SIZE                                       0                                                                                                // set by library:dataflash
#define MBED_CONF_DATAFLASH_DATAFLASH_SIZE                                    0                                                                                                // set by library:dataflash
#define MBED_CONF_DATAFLASH_SPI_CLK                                           NC                                                                                               // set by library:dataflash
#define MBED_CONF_DATAFLASH_SPI_CS                                            NC                                                                                               // set by library:dataflash
#define MBED_CONF_DATAFLASH_SPI_MISO                                          NC                                                                                               // set by library:dataflash
#define MBED_CONF_DATAFLASH_SPI_MOSI                                          NC                                                                                               // set by library:dataflash
...
#define MBED_CONF_IDW0XX1_RX                                                  NC                                                                                               // set by library:idw0xx1
#define MBED_CONF_IDW0XX1_TX                                                  NC                                                                                               // set by library:idw0xx1
...
#define MBED_CONF_MBED_CLOUD_CLIENT_UPDATE_DOWNLOAD_PROTOCOL                  MBED_CLOUD_CLIENT_UPDATE_DOWNLOAD_PROTOCOL_HTTP                                                  // set by library:mbed-cloud-client
...
#define MBED_CONF_NANOSTACK_HAL_EVENT_LOOP_THREAD_STACK_SIZE                  8192                                                                                             // set by application[*]
...
#define MBED_CONF_SD_SPI_CLK                                                  PTE2                                                                                             // set by library:sd[K64F]
#define MBED_CONF_SD_SPI_CS                                                   PTE4                                                                                             // set by library:sd[K64F]
#define MBED_CONF_SD_SPI_MISO                                                 PTE1                                                                                             // set by library:sd[K64F]
#define MBED_CONF_SD_SPI_MOSI                                                 PTE3                                                                                             // set by library:sd[K64F]
#define MBED_CONF_SPIF_DRIVER_SPI_CLK                                         NC                                                                                               // set by library:spif-driver
#define MBED_CONF_SPIF_DRIVER_SPI_CS                                          NC                                                                                               // set by library:spif-driver
#define MBED_CONF_SPIF_DRIVER_SPI_FREQ                                        40000000                                                                                         // set by library:spif-driver
#define MBED_CONF_SPIF_DRIVER_SPI_MISO                                        NC                                                                                               // set by library:spif-driver
#define MBED_CONF_SPIF_DRIVER_SPI_MOSI                                        NC                                                                                               // set by library:spif-driver
#define MBED_CONF_SPIRIT1_MAC_ADDRESS                                         {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}                                                         // set by library:spirit1
#define MBED_CONF_STORAGE_SELECTOR_FILESYSTEM                                 FAT                                                                                              // set by application[*]
#define MBED_CONF_STORAGE_SELECTOR_FILESYSTEM_INSTANCES                       1                                                                                                // set by library:storage-selector
#define MBED_CONF_STORAGE_SELECTOR_HEAP_SIZE                                  2048                                                                                             // set by library:storage-selector
#define MBED_CONF_STORAGE_SELECTOR_MOUNT_POINT                                "sd"                                                                                             // set by application[*]
#define MBED_CONF_STORAGE_SELECTOR_STORAGE                                    SD_CARD                                                                                          // set by application[*]
...
#define MBED_CONF_UPDATE_CLIENT_HTTP_RESUME_ATTEMPT_TEST_MESSAGES_ENABLE      0                                                                                                // set by library:update-client
#define MBED_CONF_UPDATE_CLIENT_HTTP_RESUME_EXPONENTIATION_FACTOR             2                                                                                                // set by library:update-client
#define MBED_CONF_UPDATE_CLIENT_HTTP_RESUME_INITIAL_DELAY_SECS                5                                                                                                // set by library:update-client
#define MBED_CONF_UPDATE_CLIENT_HTTP_RESUME_MAXIMUM_DELAY_SECS                (60*60)                                                                                          // set by library:update-client
#define MBED_CONF_UPDATE_CLIENT_HTTP_RESUME_MAXIMUM_DOWNLOAD_TIME_SECS        (7*24*60*60)                                                                                     // set by library:update-client
#define MBED_CONF_UPDATE_CLIENT_STORAGE_ADDRESS                               (1024*1024*64)                                                                                   // set by application[*]
...
#define MBED_CONF_UPDATE_CLIENT_STORAGE_SIZE                                  (1024*1024*2)                                                                                    // set by application[*]
...
#define MCC_PLATFORM_AUTO_PARTITION                                           1                                                                                                // set by library:client_app[*]
...
#define PAL_INTERNAL_FLASH_SECTION_1_ADDRESS                                  (32*1024)                                                                                        // set by library:client_app[K64F]
#define PAL_INTERNAL_FLASH_SECTION_1_SIZE                                     ( 4*1024)                                                                                        // set by library:client_app[K64F]
#define PAL_INTERNAL_FLASH_SECTION_2_ADDRESS                                  (36*1024)                                                                                        // set by library:client_app[K64F]
#define PAL_INTERNAL_FLASH_SECTION_2_SIZE                                     ( 4*1024)                                                                                        // set by library:client_app[K64F]
#define PAL_NUMBER_OF_PARTITIONS                                              1                                                                                                // set by library:client_app[*]
// Macros
...
#define MBED_CONF_APP_MAIN_STACK_SIZE                                         5120                                                                                             // defined by library:client_app
...
#define PLATFORM_ENABLE_BUTTON                                                1                                                                                                // defined by library:client_app
#define PLATFORM_ENABLE_LED                                                   1                                                                                                // defined by library:client_app
